    ...
    try {
        ...
        const dataQuery = `
            SELECT 
                ...
                s.secondary_phone AS whatsappnumber,
                ...
                (
                    CASE
                        WHEN (SELECT COUNT(*) FROM voucherdetails vd WHERE vd.file_id = vh.file_id and vd.branch_id=vh.branch_id AND vd.quantity != vd.balance_quantity)>0 THEN 'N'
                        else 'Y'
                    END
