import 'package:LeLaundrette/controller/dashboard/settings/relationship/relationship_controller.dart';
...
class _RelationShipListScreenState extends State<RelationShipListScreen>
  ...
  late RelationShipListController controller =
      Get.put(RelationShipListController());
                        ...
                        children: [
                          ...
                          MyBreadcrumb(
                            children: [
                              ...
                              MyBreadcrumbItem(name: 'Relationship'),
                            ],
                          ),
                        ],
                      ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                PermissionHandler(
                    permission: 'settings_relationship_add', child: addData()),
                IOUtils.fields(
                  "Search",
                  "Search",
            ...
            IOUtils.dataTable<dynamic>(
              ...
              actionList: [
                TableAction(
                    permission: 'settings_relationship_edit',
                    function: (data) {
                ...
                TableAction(
                    permission: 'settings_relationship_delete',
                    function: (data) async {
  ...
  void editRelationship(dynamic data) {
    showGeneralDialog(
        barrierColor: Colors.transparent,
        context: context,
        pageBuilder: (a, b, c) {
