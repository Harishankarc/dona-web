import 'package:LeLaundrette/controller/dashboard/settings/models/models_controller.dart';
...
class _ModelsListScreenState extends State<ModelsListScreen>
  ...
  late ModelsListController controller = Get.put(ModelsListController());
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                PermissionHandler(
                    permission: 'settings_models_add', child: addData()),
                IOUtils.fields(
                  "Search",
                  "Search",
            ...
            IOUtils.dataTable<dynamic>(
              ...
              actionList: [
                TableAction(
                    permission: 'settings_models_edit',
                    function: (data) {
                ...
                TableAction(
                    permission: 'settings_models_delete',
                    function: (data) async {
