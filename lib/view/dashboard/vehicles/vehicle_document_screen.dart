...
class VehiclesDocumentScreen extends StatefulWidget {
  const VehiclesDocumentScreen({
    super.key,
  });

  @override
  State<VehiclesDocumentScreen> createState() => _VehiclesDocumentScreenState();
}

class _VehiclesDocumentScreenState extends State<VehiclesDocumentScreen>
    with UIMixin, TickerProviderStateMixin {
  VehiclesDocumentController controller = Get.put(VehiclesDocumentController());
                        ...
                        children: [
                          ...
                          MyBreadcrumb(
                            children: [
                              ...
                              MyBreadcrumbItem(name: 'Vehicle Documents'),
                            ],
                          ),
                        ],
                      ),
                      ...
                      TableAction(
                          function: (data) async {
                            DeleteView.deleteDialog(
                                data["id"].toString(),
                                'vehicle_documents',
                                "${data["document_type_name"]} of ${data["vehicle_name"]}",
                                toastMessage,
                                controller.loadData,
                                context);
                          },
